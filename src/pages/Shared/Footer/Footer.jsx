  ...
  return (
    <footer className="bg-slate-100">
      <div className=" flex text-neutral-content">
        <div className="bg-[#1F2937] py-6 w-1/2 flex justify-center ">
        <aside className="">
        ...
        <nav className="w-1/2 bg-[#111827] py-6 flex justify-center">
          <div>
      ...
      <footer className="footer text-white  footer-center p-4 bg-[#151515] ">
        <aside>
          <p>
